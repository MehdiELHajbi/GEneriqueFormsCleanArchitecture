...
namespace EntityFrameworkCore.Generator.Parsing
{
    public class SourceSynchronizer
    {
        ...
        //public bool UpdateFromSource(EntityContexts generatedContext, GeneratorOptions options)
        //{
        ...
        private void UpdateFromContext(EntityContexts generatedContext, string contextDirectory)
        {
            if (generatedContext == null
        ...
        //private void UpdateFromMapping(EntityContexts generatedContext, string mappingDirectory)
        //{
        //    if (generatedContext == null
        ...
        private void RenameEntity(EntityContexts generatedContext, string originalName, string newName)
        {
        ...
        private void RenameProperty(EntityContexts generatedContext, string entityName, string originalName, string newName)
        {
            if (originalName == newName)
                return;
