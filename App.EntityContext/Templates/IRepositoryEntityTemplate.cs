...
{
    public class IRepositoryEntityTemplate : CodeTemplateBase
    {
        private readonly Entity _entity;

        public IRepositoryEntityTemplate(Entity entity) : base()
        {
            _entity = entity;
        }
        ...
        public override string WriteCode()
        {
            ...
            var extensionNamespace = "Application.Contracts";
        ...
        {
            var entityClass = "I" + _entity.EntityClass + "Repository";
            ...
            CodeBuilder.AppendLine($"public interface {entityClass} : IAsyncRepository<" + _entity.EntityClass + ">");
            CodeBuilder.AppendLine("{");
