...
{
    public class ConfigureClassTemplate : CodeTemplateBase
    {
        private Entity _entity;

        public ConfigureClassTemplate(Entity entity) : base()
        {
            _entity = entity;
        }
        ...
        public override string WriteCode()
        {
            ...
            CodeBuilder.AppendLine($"namespace {_entity.ConfigureNamespace}");
            CodeBuilder.AppendLine("{");
        ...
        {
            var mappingClass = _entity.ConfigureClass;
            var entityClass = _entity.EntityClass;
